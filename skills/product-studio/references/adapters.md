...
| Visual design canvas | Host `/design` canvas skill, published as an Artifact the user can edit | Design Prompt at `.product-studio/artifacts/design-prompt.md` for the user to run elsewhere |
