...
REQUIRED = [
    ...
    "skills/product-studio/references/hackathon-mode.md",
    "skills/product-studio/references/workflow-profile.md",
    "skills/product-studio/references/host-capabilities.md",
    "scripts/workflow_profile.py",
    "schemas/workflow-profile.schema.json",
    "skills/workflow-init/agents/openai.yaml",
    "skills/engineering-cycle/agents/openai.yaml",
    "skills/product-recheck/agents/openai.yaml",
    "skills/workflow-init/templates/ci/github/workflows/ci-full.yml",
    "skills/product-studio/references/idea-validation.md",
    "skills/product-studio/references/define-loop.md",
    "skills/product-studio/references/design-loop.md",
    "templates/design-prompt.md",
