...
DONE_BARS = {
    ...
    "design": ["magic moment defined and reachable from the onboarding path", "landing / store copy written", "design system defined", "exactly three principles", "design prompt written"],
